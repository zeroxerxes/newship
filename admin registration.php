                          ...
                          <td><table bgcolor="#FFFFFF" border="0" cellpadding="3" cellspacing="1" width="100%">
                              ...
                              <tr>
							   ...
							   <tr>
                                ...
                                <td width="">:</td>
                                <td width="">
								<input name="txtemailid" class="forminput" id="txtemailid" maxlength="50" type="text" placeholder="enter your e-mail id" size="30" required></td>
                              </tr>
							   <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">Confirm E-mail Id</font></td>
                                <td width="">:</td>
                                <td width="">
								<input name="txtemailid" class="forminput" id="txtemailid" maxlength="50" type="text" placeholder="re-enter your e-mail id" size="30" required></td>
                              </tr>
							   <tr>
